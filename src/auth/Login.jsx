...
const Login = () => {
  ...
  const { user, isAdmin, loading, error } = useSelector((state) => state.auth);
    ...
    <div className="min-h-screen bg-teal-50 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white rounded-3xl shadow-2xl shadow-teal-100 p-8 sm:p-10 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">HealthCenter</h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-300 hover:border-gray-300 hover:bg-gray-50 rounded-xl text-sm font-semibold text-gray-700  disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
        >
          {loading ? (
